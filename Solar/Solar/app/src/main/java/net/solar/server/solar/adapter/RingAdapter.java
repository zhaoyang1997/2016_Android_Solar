...
public class RingAdapter extends BaseAdapter {
    ...
    private List<Bells> list=new ArrayList<Bells>();

    public RingAdapter(Activity context, int item_layout_id, List list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textView=convertView.findViewById(R.id.tv_Ring);
